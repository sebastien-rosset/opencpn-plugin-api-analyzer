...
# Configuration
API_HEADER_URL = "https://raw.githubusercontent.com/OpenCPN/OpenCPN/master/include/ocpn_plugin.h"
...
def main():
    ...
    results = analyzer.analyze_plugins(plugin_names=PLUGINS_TO_ANALYZE if PLUGINS_TO_ANALYZE else None)
